...
@interface TopUpRecordController ()<UITableViewDelegate,UITableViewDataSource>

@property (nonatomic,strong) UITableView * tableView;

@end

//static NSString * topUpCellID = @"topUpCellID";
...
{
    TopUpViewCell * projectcell = [[NSBundle mainBundle]loadNibNamed:@"TopUpViewCell" owner:nil options:nil].lastObject;
