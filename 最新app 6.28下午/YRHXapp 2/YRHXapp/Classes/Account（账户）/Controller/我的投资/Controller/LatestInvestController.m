...
@interface LatestInvestController ()<UITableViewDelegate,UITableViewDataSource>
...
@implementation LatestInvestController
...
{
    MyInvestCell * myInvestcell = [[NSBundle mainBundle]loadNibNamed:@"MyInvestCell" owner:nil options:nil].lastObject;
