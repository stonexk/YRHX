//
//  YRHXCreditorTransferController.m
//  YRHXapp
//
...
@interface YRHXCreditorTransferController ()<UIScrollViewDelegate>
...
@implementation YRHXCreditorTransferController
...
- (void)creatContentView
{
    ...
    //分别创建三个控制器
    AlreadyHoldController * alredyholdVc = [[AlreadyHoldController alloc]init];
    CouldTransferController * couldTransferVc = [[CouldTransferController alloc]init];
    AlreadyTransferController * alreadyTransferVc = [[AlreadyTransferController alloc]init];
    
    
    //把控制器对应的view添加到contentView上
    [contentView addSubview:alredyholdVc.view];
    [contentView addSubview:couldTransferVc.view];
    [contentView addSubview:alreadyTransferVc.view];
    
    //建立父子关系
    [self addChildViewController:alredyholdVc];
    [self addChildViewController:couldTransferVc];
    [self addChildViewController:alreadyTransferVc];

    [alredyholdVc didMoveToParentViewController:self];
    [couldTransferVc didMoveToParentViewController:self];
    [alreadyTransferVc didMoveToParentViewController:self];
