...
@interface ExchangeRecordController ()<UITableViewDelegate,UITableViewDataSource>
...
{
    ExchangeRecordCell * cell = [[NSBundle mainBundle]loadNibNamed:@"ExchangeRecordCell" owner:nil options:nil].lastObject;
