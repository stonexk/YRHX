//
//  AlreadyExpeirdViewController.m
//  YRHXapp
//
...
@interface AlreadyExpeirdViewController ()<UITableViewDelegate,UITableViewDataSource>

@property (nonatomic,strong) UITableView * tableView;

@end

@implementation AlreadyExpeirdViewController
