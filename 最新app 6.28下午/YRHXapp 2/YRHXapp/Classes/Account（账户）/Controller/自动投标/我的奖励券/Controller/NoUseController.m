...
@interface NoUseController ()<UITableViewDelegate,UITableViewDataSource>

@property (nonatomic,strong) UITableView * tableView;

@end

@implementation NoUseController
...
-(UITableView *)tableView{    
    if (_tableView == nil) {
        _tableView = [[UITableView alloc] initWithFrame:CGRectMake(0, 0, screenBounds.size.width, tableViewHeight + 74)];
...
{
    MyVoucherCell * myInvestcell = [[NSBundle mainBundle]loadNibNamed:@"MyVoucherCell" owner:nil options:nil].lastObject;
