...
//        [self addSubview:self.percentLB];
        ...
        self.percentLB.frame = CGRectMake(200, 300, 40, 30);
...
- (void)setProgress:(double)value animated:(BOOL)animate
{
    ...
    self.percentLB.text = [NSString stringWithFormat:@"%.0f%%",_progress*100];
...
//    bgCircleLayer.strokeColor = BackGroundColor.CGColor;
    bgCircleLayer.strokeColor = [UIColor colorWithHexString:@"ffdd4d"].CGColor;
